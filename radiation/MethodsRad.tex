...
Conventional calculations for dose equivalent in tissue requires use of Monte Carlo to calculate a conversion factor \cite{Stuart-Thesis} and is outside the SORA missions' scope of study.
