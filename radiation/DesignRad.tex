...
Once the Timepix data was collected, it would be analyzed in real-time and the particle counts and dose would be sent as part of the data packet. 
...
The module was constructed using the materials and material proportions given by Ref. \ref{NASA-ISS-Construction}.
The layers of the module can be seen in Figure \ref{fig:iss-module}.
