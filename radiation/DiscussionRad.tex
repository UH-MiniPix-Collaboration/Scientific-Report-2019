...
While computational models are a powerful tool, they are currently not well-suited for monitoring astronauts' exposure to radiation.
As stated by Schwadron et. al. \cite{Schwadron-Update} from the CRaTER experiment, observed dose rates in the interplanetary environment exceed computational predictions by about 10\%.
